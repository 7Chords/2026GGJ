...
{
    public class UINodeGuideMap : _ASCUINodeBase
    {
        public UINodeGuideMap(SCUIShowType _showType) : base(_showType)
        {
        }
        ...
        {
            return nameof(UINodeGuideMap);
        }

        public override string GetResName()
        {
            return "panel_guide_map";
        }
