...
{
    public class UIPanelBattleFace : _ASCUIPanelBase<UIMonoMaskCombineFace>
    {
        ...
        public UIPanelBattleFace(UIMonoMaskCombineFace _mono, SCUIShowType _showType) : base(_mono, _showType)
        {
        }
        ...
        private void CreateGrids()
        {
             ...
             for(int y=0; y<mono.rowCount; y++)
             {
                 ...
                 {
                     GameObject go = ResourcesHelper.LoadGameObject(mono.gridPrefabName, mono.transform);
