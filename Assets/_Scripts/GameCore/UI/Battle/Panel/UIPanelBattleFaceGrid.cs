...
{
    public class UIPanelBattleFaceGrid : _ASCUIPanelBase<UIMonoBattleFaceGrid>
    {
        private FaceGridInfo _m_gridInfo;
        public UIPanelBattleFaceGrid(UIMonoBattleFaceGrid _mono, SCUIShowType _showType) : base(_mono, _showType)
        {
        }
