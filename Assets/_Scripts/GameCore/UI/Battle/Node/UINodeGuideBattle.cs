...
{
    public class UINodeGuideBattle : _ASCUINodeBase
    {
        public UINodeGuideBattle(SCUIShowType _showType) : base(_showType)
        {
        }
        ...
        {
            return nameof(UINodeGuideBattle);
        }

        public override string GetResName()
        {
            return "panel_guide_battle";
        }
