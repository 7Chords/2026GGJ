...
{
    public class UINodeLose : _ASCUINodeBase
    {
        public UINodeLose(SCUIShowType _showType) : base(_showType)
        {
        }
        ...
        private UIPanelLose _m_deckPanel;
        ...
        public override void OnEnterNode()
        {
            ...
            if (_m_panelGO == null)
            {
                Debug.LogError("δ�ҵ���Դ��Ϊ" + GetResName() + "����Դ!!!");
                return;
            }
            ...
            _m_deckPanel = new UIPanelLose(_m_deckMono, _m_showType);
